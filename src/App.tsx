    ...
    return (
        <div className="App">
            ...
            <Box>
                ...
                <StyledBtn color={myTheme.colors.secondary} btnType={"second"} active>Click me</StyledBtn>
                <StyledBtn color={myTheme.colors.primary} btnType={"first"}>Click me</StyledBtn>
